      ...
      <tr>
        ...
        <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="12%" height="18" background="images/web/tab/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2 STYLE1">主要配置</div></td>
            <td width="13%" height="18" background="images/web/tab/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2 STYLE1">包含设备</div></td>
            <td width="5%" height="18" background="images/web/tab/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2">单位</div></td>
            <td width="5%" height="18" background="images/web/tab/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2">数量</div></td>
            <td width="6%" height="18" background="images/web/tab/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2">单价</div></td>
            <td width="5%" height="18" background="images/web/tab/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2">金额</div></td>
            <td width="6%" height="18" background="images/web/tab/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2">是否必须</div></td>
            <td width="13%" height="18" background="images/web/tab/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2">备注</div></td>
            <td width="15%" height="18" background="images/web/tab/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2">操作</div></td>
          </tr>
          <tr>
