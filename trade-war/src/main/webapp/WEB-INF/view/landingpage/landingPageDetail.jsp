			...
			<div class="form-horizontal form-view col-md-12">
				<div class="controls col-md-12 bottom-line top-line">
					...
					<div class="controls col-md-3">
						<input id="channelName" name="pageName" value="${openLandingPage.pageName}" class="col-md-7" type="text" maxlength="50" disabled/>
					</div>
				</div>
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">着陆页编号<span class="must"><span style="color: red">*</span></span></label>
					<div class="controls col-md-3">
						<input id="channelName" name="pageCode" value="${openLandingPage.pageCode}" class="col-md-7" type="text" maxlength="50" disabled/>
					</div>
				</div>
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">创建时间<span class="must"><span style="color: red">*</span></span></label>
					<div class="controls col-md-3">
						<input id="channelName" name="pageCode" value="<fmt:formatDate value="${openLandingPage.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" class="col-md-7" type="text" maxlength="50" disabled/>
					</div>
				</div>
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">着陆页类型<span class="must"><span style="color: red">*</span></span></label>
					<div class="controls col-md-3">
						<select class="col-md-7" name="pageType" disabled>
				...
				<div class="controls col-md-12 bottom-line top-line">
					...
					<div class="controls col-md-3">
						<select class="col-md-7" name="state" disabled>
				...
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">url地址<span
						class="must"><span style="color: red">*</span></span></label>
					<div class="controls col-md-3">
						<input id="siteUrl" name="pageUrl" value="${openLandingPage.pageUrl}" class="col-md-7" type="text" maxlength="50" disabled/>
					</div>
				</div>
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">添加人姓名<span
						class="must"><span style="color: red">*</span></span></label>
					<div class="controls col-md-3">
						<input id="siteUrl" name="pageUrl" value="${openLandingPage.createName}" class="col-md-7" type="text" maxlength="50" disabled/>
					</div>
				</div>
