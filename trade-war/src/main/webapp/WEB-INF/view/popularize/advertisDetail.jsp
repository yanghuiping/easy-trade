		...
		<form id="advertisForm" action="${ctx}/advertisManage/saveAdvertis.do" method="post">
			<div class="form-horizontal form-view col-md-12">
				...
				<div class="controls col-md-12 bottom-line top-line">
					...
					<div class="controls col-md-3">
						<c:choose>
								<c:when test="${advertis.isApproval == 1}">
									<input type="radio" name="isApproval" value="1" checked disabled/>是
									&nbsp;
									<input type="radio" name="isApproval" value="0" disabled/>否
								</c:when>
								<c:when test="${advertis.isApproval == 0}">
									<input type="radio" name="isApproval" value="1" disabled/>是
									&nbsp;
									<input type="radio" name="isApproval" value="0" checked disabled/>否
								</c:when>
						</c:choose>
