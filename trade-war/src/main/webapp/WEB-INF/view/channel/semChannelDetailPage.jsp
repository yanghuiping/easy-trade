		...
		<form id="channelForm" action="${ctx}/channelManage/semChannelSave.do" method="post">
			<div class="form-horizontal form-view col-md-12">
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">伙伴名称<span class="must"></label>
					<div class="controls col-md-3">
						<input id="channelName" name="openChannel.channelName" value="${openChannel.channelName}" class="col-md-7" type="text" maxlength="50" disabled/>
					</div>
				</div>
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">真实姓名<span
						class="must"></label>
					<div class="controls col-md-3">
						<input id="realName" name="openChannelDetail.realName" value="${openChannelDetail.realName}" class="col-md-7" type="text" maxlength="50" disabled/>
					</div>
				</div>
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">联系电话<span class="must"></label>
					<div class="controls col-md-3">
						<input id="phone" name="openChannelDetail.phone" value="${openChannelDetail.phone}" class="col-md-7" type="text" maxlength="50" disabled/>
					</div>
				</div>
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">电子邮件<span
						class="must"></label>
					<div class="controls col-md-3">
						<input id="email" name="openChannelDetail.email" value="${openChannelDetail.email}" class="col-md-7" type="text" maxlength="50" disabled/>
					</div>
				</div>
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">公司名称<span class="must"></label>
					<div class="controls col-md-3">
						<input id="compayName" name="openChannelDetail.compayName" value="${openChannelDetail.compayName}" class="col-md-7" type="text" maxlength="50" disabled/>
					</div>
				</div>
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">网址<span
						class="must"></label>
					<div class="controls col-md-3">
						<input id="siteUrl" name="openChannelDetail.siteUrl" value="${openChannelDetail.siteUrl}" class="col-md-7" type="text" maxlength="50" disabled/>
					</div>
				</div>
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">伙伴类型<span class="must"></label>
					<div class="controls col-md-3">
				...
				<div class="controls col-md-12 bottom-line top-line">
					<label class="control-label col-md-1">创建时间：<span class="must"></label>
					<div class="controls col-md-3">
