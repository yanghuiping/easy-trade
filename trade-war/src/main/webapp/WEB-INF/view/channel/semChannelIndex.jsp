...
<script type="text/javascript" src="${app_static_root}/view/channel/semChannelIndex.js"></script>
<body >
<ul class="breadcrumb">
	...
	<form id="searchForm" name="searchForm" class="form-horizontal">
		<table class="responsive table" >
			 	<tr>						 		
					...
					<td>
						<button id="btnQuery" name="btnQuery" type="button" class="btn  btn-small btn-primary" onclick="semManageList(1,0,10);">
							<i class="icon-search icon-on-right bigger-110"></i>查询 </button>
						<input type="hidden" name="semChannelListUrl" id="semChannelListUrl" value="${ctx}/channelManage/semChannelList.do"/>
					</td>							
				</tr>	
		</table>
	</form>
</div>
<div class="widget-container" id="semChannelList">
</div>
</body>